    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="rounded-2xl border border-border/50 bg-card/30 p-8 sm:p-12 text-center">
          ...
          <p className="font-body text-muted-foreground max-w-2xl mx-auto leading-relaxed"> The SPINN more than a radio station — it's a sanctuary for music lovers. Our channels are curated by passionate DJs who breathe Jazz, Neo S delivering an uninterrupted stream of timeless classics and fresh discoveries
